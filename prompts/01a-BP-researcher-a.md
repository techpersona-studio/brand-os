...
- Client-owned social profiles, if provided
...
4. Footer — address, phone, service area, license numbers, social links
...
7. Social profiles — only if client-provided
...
- [ ] Checked social profiles (if provided)
...
* If file writing is not supported: output the full structured report in the response.
* Use the client slug derived from the client name (lowercase, hyphenated) for folder and file names.
* Output filename: `outputs/{slug}/handoff/01a-researcherA-handoff.md`
