...
2. Optional **Business Persona**
3. Optional **Branding Visual Guide**
4. Optional **SEO Foundation Brief**
5. Optional **client notes**
6. Optional **screenshots or reference pages**

Use the current website as the primary subject of analysis.

If Business Persona, Branding Visual Guide, or SEO Foundation Brief are available, use them as the benchmark for what the website should be doing.

If the SEO Foundation Brief is provided:
...
### Optional Business Persona

{{BUSINESS_PERSONA}}

### Optional Branding Visual Guide

{{BRANDING_VISUAL_STRATEGIST}}

### Optional SEO Foundation Brief

{{SEO_FOUNDATION_BRIEF}}
...
* Output A filename: `outputs/{slug}/details/web-analysis-report.md`
* Output B filename: `outputs/{slug}/handoff/web-analysis-handoff.md`
* Output A is client-facing. Keep the professional, structured tone throughout.
* Output B is internal. Builder-ready decisions only — no client-facing language.
