...
1. **Website Blueprint Handoff**
2. **Branding Visual Guide**

### Optional

3. **Business Persona** — only if messaging nuance is needed
4. **Current website** — only for migration or asset recovery
5. **SEO rules / SEO handoff** — only if not already embedded in the blueprint
...
{{WEBSITE_BLUEPRINT_HANDOFF}}

### Branding Visual Guide

{{BRANDING_VISUAL_GUIDE}}
...
### Optional current website / assets

{{CURRENT_WEBSITE_OR_ASSETS}}
...
* Output filename: `outputs/{slug}/website/{slug}-website.html`
